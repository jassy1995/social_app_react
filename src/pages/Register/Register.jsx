    ...
    <div className="login flex justify-center items-center bg-[#f0f2f5] w-[100vw] h-[100vh]">
      <div className="loginWrapper flex w-[70%] h-[70%] space-x-4">
        ...
        <div className="loginRight flex flex-1 flex-col justify-center">
          <div className="loginBox flex flex-col p-10 h-[406px] bg-white rounded-sm justify-betwee">
            <input
             value={username}
             onChange={(e)=>setUserName(e.target.value)}
              ...
              className="block w-full px-4 py-2  bg-white border rounded-md focus:border-[#1775ee] focus:ring-[#619dec] focus:outline-none focus:ring focus:ring-opacity-40 mb-4"
            />
            <input
             value={email}
            ...
            <button
              ...
              className="py-2 mb-4 mt-2 text-white rounded-md outline-none border-0 font-medium cursor-pointer bg-[#1775ee] disabled:bg-blue-400 disabled:cursor-not-allowed"
              disabled={isLoading}

            >
              {isLoading ? "Registring..." : "Sign Up"}
            </button>
